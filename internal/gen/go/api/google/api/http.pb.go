...
const file_api_google_api_http_proto_rawDesc = "" +
	"\n" +
	"\x19api/google/api/http.proto\x12\n" +
	"google.api\"y\n" +
	"\x04Http\x12*\n" +
...
var (
	...
	file_api_google_api_http_proto_rawDescData []byte
)

func file_api_google_api_http_proto_rawDescGZIP() []byte {
	file_api_google_api_http_proto_rawDescOnce.Do(func() {
		file_api_google_api_http_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_google_api_http_proto_rawDesc), len(file_api_google_api_http_proto_rawDesc)))
	})
...
var file_api_google_api_http_proto_goTypes = []any{
...
func file_api_google_api_http_proto_init() {
	...
	file_api_google_api_http_proto_msgTypes[1].OneofWrappers = []any{
		(*HttpRule_Get)(nil),
		(*HttpRule_Put)(nil),
		(*HttpRule_Post)(nil),
		(*HttpRule_Delete)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_google_api_http_proto_rawDesc), len(file_api_google_api_http_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
