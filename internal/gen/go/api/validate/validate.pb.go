...
const file_api_validate_validate_proto_rawDesc = "" +
	"\n" +
	"\x1bapi/validate/validate.proto\x12\bvalidate\x1a google/protobuf/descriptor.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc8\b\n" +
	"\n" +
	"FieldRules\x120\n" +
...
var (
	...
	file_api_validate_validate_proto_rawDescData []byte
)

func file_api_validate_validate_proto_rawDescGZIP() []byte {
	file_api_validate_validate_proto_rawDescOnce.Do(func() {
		file_api_validate_validate_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_validate_validate_proto_rawDesc), len(file_api_validate_validate_proto_rawDesc)))
	})
...
var file_api_validate_validate_proto_goTypes = []any{
...
func file_api_validate_validate_proto_init() {
	...
	file_api_validate_validate_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_api_validate_validate_proto_msgTypes[14].OneofWrappers = []any{
	...
	file_api_validate_validate_proto_msgTypes[15].OneofWrappers = []any{
		(*BytesRules_Ip)(nil),
		(*BytesRules_Ipv4)(nil),
		(*BytesRules_Ipv6)(nil),
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_validate_validate_proto_rawDesc), len(file_api_validate_validate_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   23,
			NumExtensions: 4,
			NumServices:   0,
